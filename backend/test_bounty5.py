...
def main():
    with httpx.Client() as client:
        ...
        res = client.post(f"{API}/requests/{req_id}/accept", headers=headers5, json={"donor_id": me5["id"]})
        print("Donor 5 accepted request:", res.status_code)
        
        res = client.post(f"{API}/requests/{req_id}/arrival", headers=headers5, json={"donor_id": me5["id"], "showed_up": True})
