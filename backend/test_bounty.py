...
def main():
    with httpx.Client() as client:
        ...
        # Someone creates a PLATELETS request for Donor 2
        res = client.post(f"{API}/requests", headers=headers2, json={
            "patient_name": "Test Platelets Patient",
            "hospital": "Test Hospital",
            "blood_type": me2["blood_type"], # Has to match the donor
            "component": "PLATELETS",
            "units": 1,
            "severity": "CRITICAL",
            "hospital_lat": 23.701,
        ...
        # Admin approves the request (skipping OCR for testing)
        ...
        # Donor 2 accepts their OWN request
        ...
        # Donor 2 marks arrival (FULFILLED)
        print("Donor 2 fulfilled the request...")
